...
class UserItem extends List {
  ...
  loadData = async () => {
    this.updateStatus(this.STATE.LOADING) // завантаження даних
  ...
  convertData = (data) => {
    return {
      ...data, // повертаю всі дані, але роблю зміну в даних user : оновлюю роль і дивлюсь чи підтверджено статус
      user: {
        ...data.user,
